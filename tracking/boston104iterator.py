# Keras iterators to train/test with the rwth-boston104 dataset
import os
...
class Boston104LocalizationIterator(tf.keras.preprocessing.image.Iterator ):
    ...
    def __init__(self, basepath,video_positions_filepath,localization_target,
        ...
        self.frames=boston104.parse_videos_to_images(self.video_positions_filepath,self.images_path,ignore_images_with_outofbounds_positions=True)
